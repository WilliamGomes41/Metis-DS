...
PATH_RULES: dict[str, tuple[str, ...]] = {
    ...
    "beschikbaarheid": (
        ...
        "src/retrieval/semantic_vector_retrieval_v1.py",
        "src/retrieval/hybrid_retrieval_v1.py",
        "src/retrieval/lexical_retrieval_v1.py",
        "src/retrieval/provider_vector_retrieval_v1.py",
