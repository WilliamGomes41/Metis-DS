...
-- Publication state is registry-based: approved canonical JSON is never mutated
...
-- Sole current external publication authority. Release rows are historical/lifecycle
-- evidence; canonical JSON publication-shaped fields are compatibility-only and inert.
