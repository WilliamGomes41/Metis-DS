...
- Protocol v2.4.0 is de normatieve baseline (v2.2.0 + v2.3-delta + v2.4-delta).
...
- PR #4 (source integrity), #5 (PDF completeness), #6 (scoped HTML), #7 (stack/G0), #8 (ontwikkelhiërarchie), #9 (v2.3-approval), #10 (integrity-kernel + runtime-entrypoints) en #11 (repositoryscope) zijn afgerond.
...
1. Protocol v2.4 via PR en CI afronden en het commitgebonden approval manifest registreren.
...
6. Pas na de MVP-gates een U1/U2-consumentencontract en partnerpilot ontwerpen.
