...
- Protocol v2.7.0 is de normatieve baseline (v2.2.0 + v2.3-delta + v2.4-delta + v2.5-delta + v2.6-delta + v2.7-delta) en is live. Het checksumgebonden approval-manifest staat in `data/assurance/protocol_v2_7_approval.json` en is gebonden aan de squash-merge van PR #19 (`d61aed6553503772df3fab16c4f12247966fc161`), de commit die de v2.7-protocolbytes bevat. Alle v2.6-consoleregels blijven van kracht. De console is goedgekeurd-niet-gebouwd; deze delta claimt geen bestaande UI.
...
2. Retrospectieve onafhankelijke C5-review van PR #4, PR #5, PR #16, Protocol v2.6 / PR #18 en Protocol v2.7 volgens de GD-03-matrix; daarna named reviewers bezetten.
