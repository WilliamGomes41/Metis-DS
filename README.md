...
External consumers integrate against the generated stable `/v1` contract in `schemas/product_api_v1.openapi.json`. The minimal onboarding and error/versioning rules are documented in `docs/product-api/CONSUMER_GUIDE_V1.md`.
