...
def test_approved_v228_delta_manifest_is_supported(tmp_path: Path):
    protocol = tmp_path / "PROTOCOL_V2_28_STRUCTURAL_HEADING_NAV_AND_CONFIRMED_STRENGTH_GATE_DELTA.md"
    protocol.write_text(
        "**Status:** Approved for project use\n"
...
def test_approved_v232_delta_manifest_is_supported(tmp_path: Path):
    protocol = tmp_path / "PROTOCOL_V2_32_DOCUMENTEN_UI_ROOM_NAME_DELTA.md"
    protocol.write_text(
        "**Status:** Approved for project use\n"
