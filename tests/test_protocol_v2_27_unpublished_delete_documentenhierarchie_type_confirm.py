...
def test_v227_single_place_is_documentenhierarchie() -> None:
    ...
    # Historical v2.27 lock keeps Documentenhiërarchie. Live room name is Protocol v2.32 **Documenten**.
    assert "**Documenten**" in root_protocol
    assert "v2.32 SUPERSEDEERT alleen de UI-naam" in root_protocol
