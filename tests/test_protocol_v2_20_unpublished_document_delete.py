...
def test_v220_delta_exists_and_is_the_live_baseline() -> None:
    ...
    assert root_protocol.count("De geldende normatieve baseline is Protocol v2.20.0") == 1
    assert "plus Protocol v2.19.0 plus Protocol v2.18.0 plus Protocol v2.17.0 plus Protocol v2.16.0 plus Protocol v2.15.0 plus Protocol v2.13.0 plus Protocol v2.12.0 plus Protocol v2.11.0" in root_protocol
