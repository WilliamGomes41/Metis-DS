...
_REASON_FAMILY = {
    ...
    "recommendation_direction_missing": SEMANTIC_CONTRACT,
    "recommendation_direction_evidence_missing": SEMANTIC_CONTRACT,
    "recommendation_strength_evidence_missing": SEMANTIC_CONTRACT,
    "recommendation_strength_unmapped": SEMANTIC_CONTRACT,
    "recommendation_semantics_invalid": SEMANTIC_CONTRACT,
    "relation_proposal_invalid": SEMANTIC_CONTRACT,
    ...
    "relation_evidence_missing": SOURCE_BINDING,
    "relation_evidence_not_source_bound": SOURCE_BINDING,
