...
PR #4 en PR #5 zijn C5-wijzigingen en vereisen nog retrospectieve onafhankelijke technical- en security/operations-review volgens deze matrix. Protocol v2.9.0 blijft een geldend C3-onderdeel (taakgerichte console-UX en V&VN digitale stylesheet). Protocol v2.10 is een eigenaarsgoedgekeurde C5-protocoldelta (identiteit/toegang spanning console-kamers/nav: Documentenhierarchie, wachttaak-badges, Accounts-kamer) en heropent GD-03 niet. Protocol v2.11 is een eigenaarsgoedgekeurde C3-protocoldelta (bron/review/publish / retrieve-safety: geüploade HTML-freeze, weigering van live URL-HTML, verplichte source locators, fail-closed Product API zonder locator) en heropent GD-03 niet. Benoemde reviewers blijven onbezet.
